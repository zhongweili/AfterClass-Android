...
import im.afterclass.android.widget.CircleImageView;
import im.afterclass.android.widget.ExpandGridView;
...
public class GroupDetailsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		clearAllHistory.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent=new Intent(GroupDetailsActivity.this, AlertDialogActivity.class);
	...
	public void exitGroup(View view) {
		startActivityForResult(new Intent(this, ExitGroupDialogActivity.class), REQUEST_CODE_EXIT);
	...
	public void exitDeleteGroup(View view) {
		startActivityForResult(new Intent(this, ExitGroupDialogActivity.class).putExtra("deleteToast", getString(R.string.dissolution_group_hint)),
...
//		adapter.refresh(EMChatManager.getInstance().getConversation(toChatUsername));
	...
	private class GridAdapter extends ArrayAdapter<String> {
		...
		public View getView(final int position, View convertView, final ViewGroup parent) {
			...
			final CircleImageView avatar =  (CircleImageView) convertView.findViewById(R.id.avatar);
			final TextView name = (TextView) convertView.findViewById(R.id.name);
			// 最后一个item，减人按钮
			if (position == getCount() - 1) {
				name.setText("");
				// 设置成删除按钮
				avatar.setImageResource(R.drawable.smiley_minus_btn);
				...
				name.setText("");
				avatar.setImageResource(R.drawable.smiley_add_btn);
				...
				/*CircleImageView avatarImage = new CircleImageView(getContext());
				avatarImage.setImageResource(R.drawable.default_avatar);
				Drawable avatar = avatarImage.getDrawable();
					...
					public void onClick(View v) {
						if (isInDeleteMode) {
							...
							if (EMChatManager.getInstance().getCurrentUser().equals(username)) {
								startActivity(new Intent(GroupDetailsActivity.this, AlertDialogActivity.class).putExtra("msg", "不能删除自己"));
								return;
							}
