...
import im.afterclass.android.adapter.GroupAdapter;
...
public class GroupsActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		groupGridView = (GridView) findViewById(R.id.gridview);
		...
		groupGridView.setOnTouchListener(new OnTouchListener() {
