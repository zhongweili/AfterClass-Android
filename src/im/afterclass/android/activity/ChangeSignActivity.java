...
public class ChangeSignActivity extends ActionBarActivity {
	...
	private void initViews(){
		...
		changeEdit.setText(preferences.getString("sign", ""));
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		@Override
			public boolean onMenuItemClick(MenuItem arg0) {
				...
				editor.putString("sign", changeEdit.getText().toString());
				editor.commit();
    			Intent intent = new Intent(ChangeSignActivity.this,PersonalInfoActivity.class);
    			setResult(1, intent);
